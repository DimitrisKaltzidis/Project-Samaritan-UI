...
$(document).ready(function() {
    ...
    samaritan.showMessageBox = function(title, message) {
        ...
        $(".message-box-loading-bar").hide();
        $(".message-box-footer").show();
    ...
    samaritan.showMessageBoxWithLoadingBar = function(title, message, complete) {
        this.clear("message-box");
        $samaritan_message_box.addClass("hidden");
        $(".message-box-loading-bar").show();
        $(".progressBar").css("width", complete+"%");
        $(".message-box-footer").css('display', 'none');
        $(".message-box-title", $samaritan_message_box).text(title);
        $(".message-box-actual-text", $samaritan_message_box).text(message ? message : "").append($("<span>").addClass("fast-flash").text(" _"));
        setTimeout(function() {
            $samaritan_message_box.removeClass("hidden");
        }, 10);
    };
